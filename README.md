...
```bash
git clone --depth 1 --branch v1.0.3 https://github.com/meSingh/polinrider-cleaner.git
...
overwritten or deleted, by anyone, including the maintainer. So `v1.0.3` will
always be exactly the code that was reviewed and released as `v1.0.3`. If you
